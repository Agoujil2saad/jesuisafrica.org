		...
		<div class="ten wide column">
			...
			<div class="demo-gallery">
				...
				<ul id="lightgallery_1" class="list-unstyled row">
					@for ($i = 1; $i < 50; $i++)
					<li class=""  data-src="images/galery/event1/event_one_{{$i}}.jpg" data-sub-html="<h4>Association Internationale Clé Pour la Paix</h4>">
						<a href="">
							<img class="img-responsive" src="images/galery/event1/thumbnails/event_one_{{$i}}_tn.jpg">
						</a>
					</li>
					@endfor
				</ul>
			...
			<div class="demo-gallery">
				...
				<ul id="lightgallery_2" class="list-unstyled row">
					@for ($i = 1; $i < 50; $i++)
					<li class=""  data-src="images/galery/event2/event_two_{{$i}}.jpg" data-sub-html="<h4>Association Internationale Clé Pour la Paix</h4>">
						<a href="">
							<img class="img-responsive" src="images/galery/event2/thumbnails/event_two_{{$i}}_tn.jpg">
						</a>
					</li>
					@endfor
				</ul>
			...
			<div class="demo-gallery">
				...
				<ul id="lightgallery_3" class="list-unstyled row">
					@for ($i = 1; $i < 50; $i++)
					<li class=""  data-src="images/galery/event3/event_three_{{$i}}.jpg" data-sub-html="<h4>Association Internationale Clé Pour la Paix</h4>">
						<a href="">
							<img class="img-responsive" src="images/galery/event3/thumbnails/event_three_{{$i}}_tn.jpg">
						</a>
					</li>
					@endfor
				</ul>
			...
			<div class="demo-gallery">
				...
				<ul id="lightgallery_4" class="list-unstyled row">
					@for ($i = 1; $i < 34; $i++)
					<li class=""  data-src="images/galery/event4/event_four_{{$i}}.jpg" data-sub-html="<h4>Association Internationale Clé Pour la Paix</h4>">
						<a href="">
							<img class="img-responsive" src="images/galery/event4/thumbnails/event_four_{{$i}}_tn.jpg">
						</a>
					</li>
					@endfor
				</ul>
